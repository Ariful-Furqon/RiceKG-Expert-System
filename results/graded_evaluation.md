...
> **Generated by**: `analysis/graded_evaluation.py` on 2026-09-19T00:47:03 UTC.  
...
| System | Committed recall | Recall incl. `possible` | Misfire | Committed precision | False alarm (controls) | Explicit rejection (controls) |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| RiceKG strict | 3/7 (42.9%) [9.9, 81.6] | 3/7 (42.9%) [9.9, 81.6] | 0/7 (0.0%) [0.0, 41.0] | 3/3 (100.0%) [29.2, 100.0] | 0/9 (0.0%) [0.0, 33.6] | 3/9 (33.3%) [7.5, 70.1] |
| RiceKG + possible | 3/7 (42.9%) [9.9, 81.6] | 5/7 (71.4%) [29.0, 96.3] | 0/7 (0.0%) [0.0, 41.0] | 3/3 (100.0%) [29.2, 100.0] | 0/9 (0.0%) [0.0, 33.6] | 3/9 (33.3%) [7.5, 70.1] |
| Flat single-tier rules | 3/7 (42.9%) [9.9, 81.6] | 3/7 (42.9%) [9.9, 81.6] | 0/7 (0.0%) [0.0, 41.0] | 3/3 (100.0%) [29.2, 100.0] | 0/9 (0.0%) [0.0, 33.6] | 0/9 (0.0%) [0.0, 33.6] |
...
| System | correct | misfire | possible_hit | possible_miss | rejected | abstain |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| RiceKG strict | 3 | 0 | 0 | 0 | 0 | 4 |
| RiceKG + possible | 3 | 0 | 2 | 0 | 0 | 2 |
| Flat single-tier rules | 3 | 0 | 0 | 0 | 0 | 4 |
...
RiceKG precision by confidence grade (grades are valid if precision falls as the grade weakens): `suspected` 3/3 (100.0%) [29.2, 100.0]; `possible` 2/5 (40.0%) [5.3, 85.3].
...
| RiceKG + possible | 0 | 0 | 1.0000 |
| Flat single-tier rules | 0 | 0 | 1.0000 |
| Nearest prototype | 0 | 1 | 1.0000 |

## dev+eval (12 positive cases, 26 negative controls)

| System | Committed recall | Recall incl. `possible` | Misfire | Committed precision | False alarm (controls) | Explicit rejection (controls) |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| RiceKG strict | 7/12 (58.3%) [27.7, 84.8] | 7/12 (58.3%) [27.7, 84.8] | 0/12 (0.0%) [0.0, 26.5] | 7/7 (100.0%) [59.0, 100.0] | 0/26 (0.0%) [0.0, 13.2] | 14/26 (53.9%) [33.4, 73.4] |
| RiceKG + possible | 7/12 (58.3%) [27.7, 84.8] | 10/12 (83.3%) [51.6, 97.9] | 0/12 (0.0%) [0.0, 26.5] | 7/7 (100.0%) [59.0, 100.0] | 0/26 (0.0%) [0.0, 13.2] | 14/26 (53.9%) [33.4, 73.4] |
| Flat single-tier rules | 7/12 (58.3%) [27.7, 84.8] | 7/12 (58.3%) [27.7, 84.8] | 0/12 (0.0%) [0.0, 26.5] | 7/7 (100.0%) [59.0, 100.0] | 0/26 (0.0%) [0.0, 13.2] | 0/26 (0.0%) [0.0, 13.2] |
...
| System | correct | misfire | possible_hit | possible_miss | rejected | abstain |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| RiceKG strict | 7 | 0 | 0 | 0 | 0 | 5 |
| RiceKG + possible | 7 | 0 | 3 | 0 | 0 | 2 |
| Flat single-tier rules | 7 | 0 | 0 | 0 | 0 | 5 |
...
RiceKG precision by confidence grade (grades are valid if precision falls as the grade weakens): `suspected` 7/7 (100.0%) [59.0, 100.0]; `possible` 3/10 (30.0%) [6.7, 65.2].
...
| System | Committed recall | Recall incl. `possible` | Misfire | Committed precision | False alarm (controls) | Explicit rejection (controls) |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| RiceKG strict | 4/18 (22.2%) [6.4, 47.6] | 4/18 (22.2%) [6.4, 47.6] | 1/18 (5.6%) [0.1, 27.3] | 4/5 (80.0%) [28.4, 99.5] | — | — |
| RiceKG + possible | 4/18 (22.2%) [6.4, 47.6] | 13/18 (72.2%) [46.5, 90.3] | 1/18 (5.6%) [0.1, 27.3] | 4/5 (80.0%) [28.4, 99.5] | — | — |
| Flat single-tier rules | 4/18 (22.2%) [6.4, 47.6] | 4/18 (22.2%) [6.4, 47.6] | 1/18 (5.6%) [0.1, 27.3] | 4/5 (80.0%) [28.4, 99.5] | — | — |
| Nearest prototype | 8/18 (44.4%) [21.5, 69.2] | 8/18 (44.4%) [21.5, 69.2] | 2/18 (11.1%) [1.4, 34.7] | 8/14 (57.1%) [28.9, 82.3] | — | — |

Positive-case outcomes:

| System | correct | misfire | possible_hit | possible_miss | rejected | abstain |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| RiceKG strict | 4 | 1 | 0 | 0 | 0 | 13 |
| RiceKG + possible | 4 | 1 | 9 | 2 | 0 | 2 |
| Flat single-tier rules | 4 | 1 | 0 | 0 | 0 | 13 |
| Nearest prototype | 8 | 2 | 0 | 0 | 0 | 8 |

RiceKG precision by confidence grade (grades are valid if precision falls as the grade weakens): `suspected` 4/5 (80.0%) [28.4, 99.5]; `possible` 9/14 (64.3%) [35.1, 87.2].
...
| FIELD_04 | dev | Rice_Root_Nematode | abstain | — |
...
| FIELD_33 | dev | Rice_Root_Nematode | possible_hit | Rice_Root_Nematode (possible) |
...
| HOLD_07 | holdout | Rice_Blast | possible_hit | Rice_Blast (possible) |
...
| HOLD_18 | holdout | Rice_Blast | possible_hit | Rice_Blast (possible) |

...
> **Positive-case recall**: **7/12** (58.3%).
...
| **FIELD_04** | `dev` | `Rice_Root_Nematode` | `Hook_Like_Root_Swelling`, `Infected_Seedlings` | *none* | *none* | `No_Diagnosis` | **`rule_recall_failure`** |
| **FIELD_05** | `dev` | `False_Smut` | `Rusty_Grain_Balls`, `Blackened_Grain_Balls` | *none* | SWRL-R17 | False_Smut | **`resolved`** |
| **FIELD_33** | `dev` | `Rice_Root_Nematode` | `Hook_Like_Root_Swelling`, `Yellowing_Leaves` | *none* | *none* | `No_Diagnosis` | **`rule_recall_failure`** |
...
| **FIELD_53** | `eval` | `Rice_Grassy_Stunt` | `Yellowing_Leaves`, `Severe_Stunting`, `Excessive_Tillering` | *none* | SWRL-R19 | Rice_Grassy_Stunt | **`resolved`** |
...
- **Dropped (no ontology term)**: *none*
- **Inferred**: `Rice_Tungro_Virus` (grade `suspected`, confidence 0.9714, antecedent coverage 0.6667) via SWRL-R20
- **Unmet antecedents**: `Necrotic_Spots`, `Whitehead_Empty_Panicles`
- **Failure cause**: **`resolved`**
...
- **Dropped (no ontology term)**: *none*
- **Inferred**: `Rice_Grassy_Stunt` (grade `suspected`, confidence 0.9714, antecedent coverage 0.4000) via SWRL-R19
- **Unmet antecedents**: `Brown_Planthopper_Present`, `Necrotic_Spots`, `No_Panicle_Formation`
- **Failure cause**: **`resolved`**
